...
class listener (StreamListener):
    ...
    def on_data(self, data):
        try:
            ...
            saveFile = open('DATABASE_RED.xml','a')
...
twitterStream.filter(track=['sad', 'depressed', 'hard', 'struggle', 'difficult', 'troubled', 'disturbed', 'down', 'upset', 'miserable', 'unlucky', 'abandoned', 'and'])
